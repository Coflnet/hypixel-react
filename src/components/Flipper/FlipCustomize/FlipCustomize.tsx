...
import { DEMO_FLIP, getFlipFinders, getFindersForFlipperFlips, getFlipCustomizeSettings } from '../../../utils/FlipUtils';
        ...
        <div className="flip-customize">
            <div style={{ width: "50%" }}>
                ...
                <div style={{ marginLeft: "30px", marginRight: "30px" }}>
                    ...
                    <Select id="finders" className="select-hide-group" isMulti options={getFindersForFlipperFlips()} defaultValue={getFlipFinders(settings.finders || [])} styles={customSelectStyle} onChange={onFindersChange} closeMenuOnSelect={false}
