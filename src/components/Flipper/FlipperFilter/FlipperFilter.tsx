    ...
    return (
        <div>
            <Form style={{ marginBottom: "5px" }} >
                <Form.Group>
                    <div>
                        <Form.Label className="flipper-filter-formfield-label">Only BIN-Auctions?:</Form.Label>
                        <Form.Check onChange={onOnlyBinChange} className="flipper-filter-formfield" type="checkbox" />
                    </div>
                </Form.Group>
                <Form.Group>
                    <div>
