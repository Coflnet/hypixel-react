            ...
            <Card>
                ...
                <Card.Body>
                    ...
                    <p>Reference auctions depend on the induvidual item, its modifiers and how often it is sold.
                        The algorythm to determine, which auctions can be used as reference, is changing frequently.
                        <br />
                        You can see the auctions used as reference by clicking on the (?) next to <code>Estimated Profit</code></p>
                    <h3>How reliable is the flipper</h3>
                    <p>Statistically very reliable. Some flips might not sell as fast as others or at all. If you encounter a flip that can't be sold please post a link to it in the skyblock channel on our discord so we can improve the flipper further.</p>
                    ...
                    <p>You get flips as soon as they are found. That allows you to buy up the most profitable flips before anyone else. Furthermore you get more filter options. Which allow you to only see flips that you are actually interested in. For a full list see <a target="_blank" href="/premium" rel="noreferrer">the premium page</a></p>
