            ...
            <Form autoComplete="off">
                <Form.Group className="search-form-group">
                    ...
                    <InputGroup id="search-input-group">
                        ...
                        <Form.Control key="search" autoFocus style={searchStyle} type="text" placeholder={props.placeholder || "Search player/item"} id={'search-bar'} className="searchBar" value={searchText} onChange={onSearchChange} onKeyPress={(e: any) => { onKeyPress(e) }} />
                    </InputGroup>
                </Form.Group>
            </Form>
