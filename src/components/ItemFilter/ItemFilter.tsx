    ...
    <div>
      ...
      {showInfoDialog ? (
        ...
        >
          ...
          <Modal.Body>
            <p>
              You can add various filters depending on the item type. The graph and recent/active auctions will be updated to only include items with the
              selected properties.
            </p>
            <hr />
            <h4>
            ...
            <p>
              Some filter requests take quite some time to process. That's because we have to search through millions of auctions that potentially match your
              filter. This can lead to no auctions being displayed at all because your browser thinks that our server is unavailable. If that happens please let
              us know. We may implement scheduled filters where you will get an email or push notification when we computed a result for your filter.
            </p>
            <p>
        ...
        <Card>
          ...
          <Card.Body>
            ...
            {props.forceOpen ? null : (
              <div>
                <Button className="btn-danger" onClick={() => onFilterClose()}>
                  Close
                </Button>
              </div>
            )}
