...
import { ShareOutlined as ShareIcon, NotificationsOutlined as NotificationIcon, Home as HomeIcon, Storefront as StorefrontIcon, AccountBalance as AccountBalanceIcon, Policy as PolicyIcon, Chat as ChatIcon, Menu as MenuIcon, Headset as HeadsetIcon } from '@material-ui/icons';
            ...
            <div className="nav-bar">
                <SideNav showNav={showNav}
                    ...
                    items={[
                        ...
                        <Link to="/ref"><div className="link-item-div"><ShareIcon className="navbar-icon" />Referral</div></Link>,
