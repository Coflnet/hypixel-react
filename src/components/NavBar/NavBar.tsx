...
import { ShareOutlined as ShareIcon, NotificationsOutlined as NotificationIcon, Home as HomeIcon, Storefront as StorefrontIcon, AccountBalance as AccountBalanceIcon, Policy as PolicyIcon, Chat as ChatIcon, Menu as MenuIcon, ExploreOutlined as ExploreIcon, TrendingDown as TrendingDownIcon } from '@material-ui/icons';
            ...
            <aside onMouseMove={onMouseMove} onMouseOut={onMouseOut} id="nav-bar">
                <ProSidebar id="pro-sidebar" style={style} collapsed={isCollapsed()} hidden={isHidden()}>
                    ...
                    <Menu iconShape="square">
                        ...
                        <MenuItem icon={<TrendingDownIcon />}><Link to="/lowSupply" >Low supply items</Link></MenuItem>
