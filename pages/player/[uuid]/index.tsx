...
function PlayerDetails(props: Props) {
  ...
  let [detailType, setDetailType_] = useState<DetailType>(
    prevDetailType || DetailType.AUCTIONS
  );
  let [selectedPlayer, setSelectedPlayer] = useState<Player>(
    parsePlayer(props.player)
  );
  let [accountInfo, setAccountInfo] = useState<AccountInfo>();
  let removeSwipeListeners = useSwipe(
    undefined,
    onSwipeRight,
    undefined,
    onSwipeLeft
  ...
  return (
    <div className='page'>
      ...
      <Container>
        ...
        />
        <ToggleButtonGroup
          className={styles.playerDetailsType}
          type='radio'
          name='options'
          value={detailType}
        ...
        >
          <ToggleButton
            value={DetailType.AUCTIONS}
            variant={getButtonVariant(DetailType.AUCTIONS)}
            size='lg'
          >
            Auctions
          </ToggleButton>
          <ToggleButton
            value={DetailType.BIDS}
            variant={getButtonVariant(DetailType.BIDS)}
            size='lg'
          >
            Bids
          </ToggleButton>
