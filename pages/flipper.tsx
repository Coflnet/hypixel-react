...
function Flipper(props: Props) {
    ...
    return (
        <div className="page" onDragOver={onDragOver} onDrop={onDrop}>
            ...
            <Container>
                <Search />
                <h2 style={{display: "flex", alignItems: "center"}}><b>Item Flipper</b>&nbsp;<span style={{backgroundColor: "white", color: "black", padding: "4px", borderRadius: "4px",fontSize:"2vh"}}>WIP</span></h2>
                <hr />
