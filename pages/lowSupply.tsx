    ...
    <div className='page'>
      ...
      <Container>
        ...
        {isLoggedIn && hasPremium ? (
          <div>
            <p>
              These are low supply items. Strong price fluctuation may occur.
            </p>
            <LowSupplyList
              lowSupplyItems={props.lowSupplyItems?.map(parseLowSupplyItem)}
            />
          </div>
        ) : null}
        {wasAlreadyLoggedIn && !isLoggedIn ? getLoadingElement() : ''}
        {!wasAlreadyLoggedIn && !isLoggedIn ? (
          <p>You need to be logged in and have premium to see this page.</p>
        ) : (
          ''
        )}
        {isLoggedIn && !hasPremium ? (
          <p>You need to have premium to see this page.</p>
        ) : (
          ''
        )}
