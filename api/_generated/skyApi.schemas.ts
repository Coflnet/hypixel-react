...
/**
 * Flat top level 3x3 recipe grid, unchanged for backwards compatibility with the website
 * @nullable
 */
export type CraftInstructionRecipe = {[key: string]: string | null} | null;

/**
 * Copy command for every ingredient tag found anywhere in the craft tree
 * @nullable
 */
export type CraftInstructionCopyCommands = {[key: string]: string | null} | null;

/**
 * Details page path for every ingredient tag found anywhere in the craft tree
 * @nullable
 */
...
export interface CraftInstruction {
  /**
     * Tag of the item the instructions were requested for
     * @nullable
     */
  itemTag?: string | null;
  /**
 ...
 * @nullable
 */
export type TaskSessionItems = {[key: string]: number} | null;
...
export interface ExtractedInfo {
  ...
  currentTaskSince: string;
  /** @nullable */
  claimedTask?: string | null;
  claimedAt: string;
...
/**
 * anti-bypass token added on the return trip (linkvertise hash / lootlabs signed token)
 */
hash?: string;
/**
 * email of the returning user, used as a fallback when the cookie is missing
 */
email?: string;
/**
 * ad provider to use, either "linkvertise" (default) or "lootlabs"
 */
provider?: string;
};
