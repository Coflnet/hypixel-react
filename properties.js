...
properties = {
    commandEndpoint:
        isSSR || window.location.host === 'localhost:3000' || window.location.hostname.includes('pr-env-sky-') ? 'https://sky.coflnet.com/command' : '/command',
    apiEndpoint:
        isSSR || window.location.host === 'localhost:3000' || window.location.hostname.includes('pr-env-sky-') ? 'https://sky.coflnet.com/api' : '/api',
