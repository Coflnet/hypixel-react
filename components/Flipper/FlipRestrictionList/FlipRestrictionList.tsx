...
function FlipRestrictionList(props: Props) {
    ...
    function getNewRestrictionElement() {
        return (
            <div>
                <ToggleButtonGroup style={{ maxWidth: "200px" }} className={priceRangeStyles.itemPriceRange} type="radio" name="options" value={newRestriction.type} onChange={onRestrictionTypeChange}>
                    <ToggleButton value={"blacklist"} variant={getButtonVariant("blacklist")} size="sm">Blacklist</ToggleButton>
                    <ToggleButton value={"whitelist"} variant={getButtonVariant("whitelist")} size="sm">Whitelist</ToggleButton>
                </ToggleButtonGroup>
