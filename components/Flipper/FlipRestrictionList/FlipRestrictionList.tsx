...
function FlipRestrictionList(props: Props) {
    ...
    let [forceNewRestrictionFilter, setForceNewRestrictionFilter] = useState<ItemFilter | undefined>()
    ...
    function onRestrictionTypeChange(value) {
        ...
        if (restriction.type === 'whitelist') {
            setForceNewRestrictionFilter({ Bin: true })
        } else {
            setForceNewRestrictionFilter(undefined)
        }
        forceUpdate()
    }
    ...
    function getNewRestrictionElement() {
        return (
            <div>
                ...
                />
                <ItemFilter
                    forceSelectedFilter={forceNewRestrictionFilter}
                    filters={filters}
                    forceOpen={true}
