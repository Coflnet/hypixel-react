...
function Startpage(props: Props) {
  ...
  function getEndString(end: Date) {
    ...
    return end.getTime() < new Date().getTime()
      ? 'Ended ' + momentDate.fromNow()
      : 'Ends ' + momentDate.fromNow();
  }
  ...
  function getNewPlayerElement(newPlayer: Player, style: React.CSSProperties) {
    return (
      <div
        className={`${styles.cardWrapper} ${styles.disableLinkStyle}`}
        key={newPlayer.name}
        style={style}
      >
  ...
  function getPopularSearchElement(
    ...
    <div>
      <div style={{ textAlign: 'center' }}>
        ...
        <p style={{ fontSize: 'larger' }}>
          Browse through over 400 million auctions, over two million players and
          the bazaar of hypixel skyblock
        </p>
        <hr />
      </div>
      <div className={styles.statusElementWrapper}>
        <Card>
          ...
          <Card.Body>
            <p>
              You can now look up a detailed breakdown of your flips in the last
              week.
            </p>
            <p>
              To look up your (or someone elses) flips, just search the player
              and click the blue "Check tracked flips" button.
            </p>
            <hr />
              ...
              <Tooltip
                ...
                tooltipContent={
                  <ul key='changelogList'>
                    ...
                    <li className={styles.changelogItem}>
                      Make it possible to differentiate between items with the
                      same name in the search
                    </li>
                    <li className={styles.changelogItem}>
                      Made multiple pages more robust if data is not valid or
                      not available
                    </li>
                    <li className={styles.changelogItem}>
                      Change the way auction names are colored
                    </li>
      ...
      <Card className={styles.startpageCard}>
        ...
        <Card.Body className={styles.startpageCardBody} id='new-auctions-body'>
          {!isSSR ? (
            ...
            <div
              className={`${styles.SSRcardsWrapper} ${styles.startpageListElementWrapper}`}
            >
      ...
      <Card className={styles.startpageCard}>
        ...
        <Card.Body
          className={styles.startpageCardBody}
          ...
          {!isSSR ? (
            ...
            >
              {popularSearches.map((search) => {
                return getPopularSearchElement(search, {
                  height: 70,
                  width: 200,
                });
              })}
      ...
      <Card className={styles.startpageCard} style={{ marginTop: '40px' }}>
        ...
        <Card.Body>
          ...
          <p>
            You can find all current and historic prices for the auction house
            and bazaar on this web tracker.
          </p>
          <p>
            We're tracking over 400 million auctions. We've saved more than 250
            million bazaar prices in intervals of 10 seconds. Furthermore, there
            are over two million skyblock players that you can search by their
            Minecraft usernames. You can browse through the auctions they made
            over the past two years. New items are added automatically and are
            available within two minutes after the first auction is started.
          </p>
          <p>
            The search autocomplete is ranked by popularity and allows you to
            find whatever item you want faster. Quick URLs allow you to link to
            specific sites. /p/Steve or /i/Oak allows you to create a link
            without visiting the site first.
          </p>
          <p>
            The free accessible{' '}
            <Link
            ...
            allows you to find profitable AH flips in no time. It supplements
            the option to browse all of the Skyblock history on the web tracker.
            What's more is that you can see what auctions were used as reference
            to determine if a flip is profitable.
          </p>
          <p>
            We allow you to subscribe to auctions, item prices and being outbid
            with more to come. Please use the contact on the{' '}
            <Link
              href='/feedback'
              style={{
                backgroundColor: 'white',
