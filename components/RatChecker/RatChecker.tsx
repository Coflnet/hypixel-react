...
function RatChecker() {
  ...
  let [checkingResults, setCheckingResults] =
    useState<[string, RatCheckingResponse][]>(null);
          ...
          if (checkingResult[1].rat.includes('No matching signature')) {
            return (
              <li style={{ color: 'white', fontSize: 'large' }}>
                <span className={styles.checkedFileName}>
                  {checkingResult[0]}
                </span>
          ...
          if (checkingResult[1].rat.includes('Yes')) {
            return (
              <li style={{ color: 'red', fontSize: 'large' }}>
                ...
                : This mod is a known rat. We recommend against using it!
              </li>
            );
          }
          if (checkingResult[1].rat.includes('No')) {
            return (
              <li style={{ color: 'lime', fontSize: 'large' }}>
                ...
                : No harmful code was found in this mod. It should be safe to
                use.
              </li>
            );
          }
      ...
      <Card>
        ...
        <Card.Body>
          {!isChecking ? (
            <div>
              <p>
                Received a suspicious (or any other mod) that you want to check?
                Select it here and get quick results for known rats or
