...
function TransferCoflCoinsSummary(props: Props) {
  ...
  function onSend() {
    ...
    api
      ...
      .then(() => {
        toast.success(
          `Successfuly sent ${numberWithThousandsSeperators(
            props.coflCoins
          )} CoflCoins to ${
      ...
      {!isSending ? (
        <div>
          ...
          <p>
            ...
            <br />
            Please make sure this is really the person you want to send
            CoflCoins to. You may not be able to get them back!
          </p>
