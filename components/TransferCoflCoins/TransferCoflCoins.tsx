  ...
  return (
    <>
      <div style={{ display: showSummary ? 'none' : 'initial' }}>
        ...
        <ul>
          <li>
            <b>By Email:</b> Enter the email of the Google account of the
            receiver
          </li>
          <li>
            <b>By Minecraft name:</b> Search the players Minecraft name (only
            works if they linked their Minecraft account on the website)
          </li>
        </ul>
        <hr />
        <div style={{ padding: '0 50px 0 50px' }}>
          ...
          <span>
            ...
            {numberWithThousandsSeperators(coflCoinsBalance)}
          </span>
          <Button
            variant='success'
            style={{ float: 'right' }}
            ...
            disabled={
              coflCoinsToSend <= 0 ||
              (email === '' && minecraftPlayer === undefined)
            }
          >
            Continue
          </Button>
