            ...
            <Table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className={styles.premiumProductColumn} style={{ color: '#08583a', fontWeight: 'bold' }}>
                            Green
                        </td>
                        <td className={styles.premiumProductColumn} style={{ color: '#6f4b00', fontWeight: 'bold' }}>
                            Gold
                        </td>
                    </tr>
                    <tr>
