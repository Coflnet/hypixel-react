...
export function BookFlips() {
    ...
    function renderFlipContent(flip: BookFlip) {
        return (
            <>
                ...
                <p>
                    <span style={{ width: '150px', float: 'left' }}>Profit per Hour:</span> {formatToPriceToShorten(flip.profitPerHour || 0)} Coins
                </p>
                <p>
    ...
    function filterFunction(flip: BookFlip, nameFilter: string | null | undefined, minimumProfit: number): boolean {
        ...
        const startTagMatch = flip.startTag ? convertTagToName(flip.startTag).toLowerCase().includes(lowerNameFilter) : false
        const endTagMatch = flip.endTag ? convertTagToName(flip.endTag).toLowerCase().includes(lowerNameFilter) : false
    ...
    return (
        <>
            <p>
                This is a list of promising Hypixel Skyblock book flips (enchanted book trades) based on estimated profit per hour and hourly volume. Book flips
                compare related enchanted-book types (start and end tags) to show opportunities where buying books of a lower level and combining them in an
                anvil can net a profit. Use this as a starting point — always verify prices in-game before committing coins.
            </p>
            <details>
                <summary>What are start/end tags?</summary>
                <p>
                    Each flip has a <b>startTag</b> and an <b>endTag</b>. The start tag is the book you would acquire (buy/order) and the end tag is the book
                    you combine to. The list shows the estimated profit per hour for combining 2 of these book type using bazaar data.
                </p>
            </details>
            <details>
                ...
                <ol>
                    ...
                    <li>
                        Place an appropriate buy order in game for the <i>start</i> book.
                    </li>
            ...
            <details>
                ...
                <p>
                    <b>Profit per Hour</b> is an estimate based on current spreads and hourly volume. It represents potential earnings under typical conditions,
                    but real results vary with market activity, fees are included already.
                    <br />
            ...
            <details>
                ...
                <p>
                    The most sensitive/top-ranked flips depend on our historical data archive and manipulation detection. To help fund the archive, the top 3
