...
function SubscriptionList() {
  ...
  let [showDeleteAllSubscriptionDialog, setShowDeleteAllSubscriptionDialog] =
    useState(false);
              ...
              result =
                price > 0 ? (
                  <li key='2'>
                    ...
                    <b>{numberWithThousandsSeperators(price)} Coins</b>
                  </li>
                ) : (
  ...
  function getSubscriptionTitle(subscription: Subscription): Promise<string> {
    return new Promise((resolve, reject) => {
      switch (subscription.type) {
        ...
        case 'player':
          api
            .getPlayerName(subscription.topicId)
            .then((playerName) => {
              resolve(playerName);
            })
            .catch(() => {
        ...
        case 'auction':
          api
            .getAuctionDetails(subscription.topicId)
            .then((auctionDetails) => {
              resolve(
