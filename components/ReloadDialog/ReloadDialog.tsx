...
function ReloadDialog(props: Props) {
  ...
  function onSubmit() {
    ...
    api
      .sendFeedback('reload', feedbackToSend)
      .then(() => {
  ...
  return (
    <div>
      <p>
        We noticed that you reloaded the page multiple times. We try to
        constantly improve our service. To do so we need to know if and what
        went wrong.
      </p>
      ...
      <Form>
        <hr />
        <Form.Group>
          <Form.Label htmlFor='loaddNewInformation'>
            I tried to load new information
          </Form.Label>
          <Form.Check
          ...
          <p style={{ fontStyle: 'italic' }}>
            If you need the most recent information on something you could try
            to create a notification for it. Currently you can create
            notifications for Items, Auctions and Players. Do you need something
            else? Please dont hesitate to ask us.
          </p>
        </Form.Group>
        <hr />
        <Form.Group>
          ...
          />
          <p style={{ fontStyle: 'italic' }}>
            You found an bug? Please tell us about it so that we can fix it as
            soon as possible.
          </p>
        </Form.Group>
        ...
        <Form.Group>
          ...
          />
          <p style={{ fontStyle: 'italic' }}>
            If you need any kind of help please join our discord or write us an
            E-Mail. We are happy to help.
          </p>
        </Form.Group>
      ...
      <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
        ...
        <Tooltip
          ...
          tooltipContent={
            !hasUserInput ? (
              <span>
                Please enter some information before submitting feedback
              </span>
            ) : null
          }
        />
